...
This monorepo is setup for a dummy `@test-org/` NPM organization. There are 2 packages by default:

- `@test-org/react` - A placholder React component
- `@test-org/utils` - A utils packages

Unlike other TSDX templates, the developer experience for this template is currently a bit more manual.

Your first order of business will be to search and replace `@test-org` for the npm organization of your own.
